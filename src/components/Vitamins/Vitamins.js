...
const Vitamins = () => {
    ...
    <br/>
    <p>SOURCES: cantaloupe, carrots, dairy products, eggs, fortified cereals, green leafy vegetables, pumpkin, red peppers, sweet potatoes</p>
    <br/>
    <h3>Vitamin C</h3>
    <p>BENEFITS & KEYWORDS: antioxidant, collagen and connective tissue formation, immune function, wound healing</p>
    <br/>
    <p>SOURCES: broccoli, brussels sprouts, cantaloupe, citrus fruits and juices, kiwifruit, peppers, strawberries, tomatoes and tomato juice</p>
    <br/>
    <h3>Vitamin D</h3>
    ...
    <br/>
    <p>SOURCES: eggs, fish, fish live oil, fortified cereals, fortified dairy products, fortified margarine, fortified orange juice, fortified soy beverages</p>
    <br/>
    <h3>Vitamin E</h3>
    <p>BENEFITS & KEYWORDS: antioxidant, formation of blood vessels, immune function</p>
    <br/>
    <p>SOURCES: fortified cereals and juices, green vegetables, nuts and seeds, peanuts and peanut butter, vegetable oils</p>
    <br/>
    <h3>Vitamin K</h3>
    <p>BENEFITS & KEYWORDS: blood clotting, strong bones</p>
    <br/>
    <p>SOURCES: green vegetables (e.g., broccoli, kale, spinach, turnip greens, collards, swiss chard, mustard greens)</p>
    <br/>
    <h3>Thiamin</h3>
    <p>BENEFITS & KEYWORDS: 1 of 8 B-complex vitamins, conversion of food into energy, nervous system function</p>
    <br/>
    <p>SOURCES: beans and peas, enriched grain products, nuts, pork, sunflower seeds, whole graims</p>
    <br/>
    <h3>Riboflavin</h3>
    <p>BENEFITS & KEYWORDS: conversion of food into energy, growth and development, red blood cell formation</p>
    <br/>
    <p>SOURCES: eggs, enriched grain products, meats, milk, mushrooms, poultry , seafood, spinach</p>
    <br/>
    <h3>Niacin</h3>
    ...
    <br/>
    <p>SOURCES: beans, beef, enriched grain products, nuts, pork, poultry, seafood</p>
    <br/>
    <h3>Panthothenic acid</h3>
    <p>BENEFITS & KEYWORDS: conversion of food into energy, fat metabolism, hormone production, nervous system function, red blood cell formation</p>
    <br/>
    <p>SOURCES: avocados, beans and peas, broccoli, eggs, milk, mushrooms, poultry, seafood, sweet potatoes, whole grains, yogurt</p>
    <br/>
    <h3>Vitamin B6</h3>
    ...
    <br/>
    <p>SOURCES: chickpeas, fruits(other than citrus), potatoes, salmon, tuna</p>
    <br/>
    <h3>Biotin</h3>
    <p>BENEFITS & KEYWORDS: energy storage, (protein, carbohydrate, and fat metabolism) </p>
    <br/>
    <p>SOURCES: avocados, cauliflower, eggs, fruits, liver, pork, salmon, whole grains</p>
    <br/>
    <h3>Folate</h3>
    <p>BENEFITS & KEYWORDS: prevention of birth defects, protein metabolism, red blood cell formation</p>
    <br/>
    <p>SOURCES: asparagus, avocado, beans and peas, enriched grain products, green leafy vegetables, orange juice</p>
    <br/>
    <h3>Vitamin B12</h3>
    <p>BENEFITS & KEYWORDS: conversion of food into energy, nervous system function, red blood cell formation</p>
    <br/>
    <p>SOURCES: dairy products, eggs, fortified cereals, meats, poultry, seafood (e.g., clams, trout, salmon, haddock, tuna)</p>
    <br/>
